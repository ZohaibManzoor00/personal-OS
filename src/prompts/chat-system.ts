...
No relevant notes were found for this question — you have nothing from Zo's knowledge base to draw on here. Do not state anything about Zo or attribute anything to him. You may still answer general questions or analyze what the user shared, as a normal assistant.`;
  }
